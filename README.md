...
Single-file front end, no build step: open `SoFlo Shine CRM.dc.html` in a browser (or serve the folder) and it runs.
...
Pintos CRM.dc.html         earlier pressure-washing version, kept for reference
```
